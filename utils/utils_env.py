...
def desc():
    ...
    if st.checkbox('이미지 보기'):
        ...
        pass
    st.write('''
            ### 3. conda create -n prjsmi python=3.9 ipython numpy pandas matplotlib folium
                            
                prjsmi이란 가상환경 이름으로 파이썬 버전을 정해주고
            
                설치하고자 하는 라이브러리를 적어줍니다.
    ...
    st.write(''''
            ...
            conda activate semiproject : semiproject 가상환경을 실행한다.
                
    codna deactivate : 가상환경을 나온다.
            ''')
